...
<div class="element hugeitmicro-item">
	<div class="left-block">
		<div class="main-image-block">
			<img src="<?php echo plugins_url( '../images/image-gallery-logo.png' , __FILE__ ); ?>">
		</div>
	</div>
	<div class="right-block">
...
<div class="element hugeitmicro-item">
	...
	<div class="right-block">
		<div class="title-block"><h3>WordPress Colorbox</h3></div>
			<p>Huge-It Colorbox is the most inimitable plugin for WordPress users that can implement popup-effect look for the images/videos (when clicking on the thumbnails of the image/video they nicely open in the same window with a beautiful effect).</p>
		<div class="description-block">
		</div>			  				
		<div class="button-block">
