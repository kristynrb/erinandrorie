...
<script>
	...
	var lightbox_initialHeight = '<?php echo $paramssld['light_box_initialheight'];?>';
        ...
        if(maxwidth > <?php echo $paramssld['light_box_width']; ?> ){ maxwidth= <?php echo $paramssld['light_box_width']; ?> ; }
        var lightbox_maxWidth = <?php if($paramssld['light_box_size_fix'] == 'true'){ echo '"100%"'; } else { echo 'maxwidth'; } ?>;
        var lightbox_maxHeight = <?php if($paramssld['light_box_size_fix'] == 'true'){ echo '"100%"'; } else { echo $paramssld['light_box_height']; } ?>;
	...
	var lightbox_retinaSuffix = "<?php echo $paramssld['light_box_retinasuffix'];?>";
				...
				jQuery("#huge_it_videogallery_content a[href$='.jpg'], #huge_it_videogallery_content a[href$='.jpeg'], #huge_it_videogallery_content a[href$='.png'], #huge_it_videogallery_content a[href$='.gif']").addClass('videogroup<?php echo $videogalleryID; ?>');
				
				jQuery(".videogroup<?php echo $videogalleryID; ?>").colorbox({rel:'videogroup<?php echo $videogalleryID; ?>'});
...
jQuery(function(){
    ...
    var $container = jQuery('#huge_it_videogallery_container_<?php echo $videogalleryID; ?>');
      ...
      $container.find('.videoelement_<?php echo $videogalleryID; ?>').each(function(){
    ...
    $container.hugeitmicro({
      itemSelector : '.videoelement_<?php echo $videogalleryID; ?>',
      masonry : {
...
jQuery(document).ready(function(){
	...
	jQuery('.videoelement_<?php echo $videogalleryID; ?> .image-block_<?php echo $videogalleryID; ?> .videogallery-image-overlay a').on('click',function(){
...
#huge_it_videogallery_content_<?php echo $videogalleryID; ?> #huge_it_videogallery_container_<?php echo $videogalleryID; ?> .videoelement_<?php echo $videogalleryID; ?> {
	width:100%;
...
#huge_it_videogallery_content_<?php echo $videogalleryID; ?> #huge_it_videogallery_container_<?php echo $videogalleryID; ?> .videoelement_<?php echo $videogalleryID; ?> .image-block_<?php echo $videogalleryID; ?> {
	position:relative;
	width:100%;
}

#huge_it_videogallery_content_<?php echo $videogalleryID; ?> #huge_it_videogallery_container_<?php echo $videogalleryID; ?> .videoelement_<?php echo $videogalleryID; ?> .image-block_<?php echo $videogalleryID; ?> img {
...
#huge_it_videogallery_content_<?php echo $videogalleryID; ?> #huge_it_videogallery_container_<?php echo $videogalleryID; ?> .videoelement_<?php echo $videogalleryID; ?> .image-block_<?php echo $videogalleryID; ?> .videogallery-image-overlay {
	position:absolute;
	top:0px;
	left:0px;
	width:100%;
...
#huge_it_videogallery_content_<?php echo $videogalleryID; ?> #huge_it_videogallery_container_<?php echo $videogalleryID; ?> .videoelement_<?php echo $videogalleryID; ?>:hover .image-block_<?php echo $videogalleryID; ?>  .videogallery-image-overlay {
	display:block;
}

#huge_it_videogallery_content_<?php echo $videogalleryID; ?> #huge_it_videogallery_container_<?php echo $videogalleryID; ?> .videoelement_<?php echo $videogalleryID; ?> .image-block_<?php echo $videogalleryID; ?> .videogallery-image-overlay a {
	position:absolute;
	top:0px;
	left:0px;
	display:block;
...
#huge_it_videogallery_content_<?php echo $videogalleryID; ?> #huge_it_videogallery_container_<?php echo $videogalleryID; ?> .videoelement_<?php echo $videogalleryID; ?> .title-block_<?php echo $videogalleryID; ?> {
	position:relative;
	height: 30px;
	margin: 0;
...
#huge_it_videogallery_content_<?php echo $videogalleryID; ?> #huge_it_videogallery_container_<?php echo $videogalleryID; ?> .videoelement_<?php echo $videogalleryID; ?> .title-block_<?php echo $videogalleryID; ?> h3 {
	position:relative;
...
#huge_it_videogallery_content_<?php echo $videogalleryID; ?> #huge_it_videogallery_container_<?php echo $videogalleryID; ?> .videoelement_<?php echo $videogalleryID; ?> .title-block_<?php echo $videogalleryID; ?> .button-block {
	position:absolute;
	right:0px;
	top:0px;
	display:none;
...
#huge_it_videogallery_content_<?php echo $videogalleryID; ?> #huge_it_videogallery_container_<?php echo $videogalleryID; ?> .videoelement_<?php echo $videogalleryID; ?>:hover .title-block_<?php echo $videogalleryID; ?> .button-block {display:block;}

#huge_it_videogallery_content_<?php echo $videogalleryID; ?> #huge_it_videogallery_container_<?php echo $videogalleryID; ?> .videoelement_<?php echo $videogalleryID; ?> .title-block_<?php echo $videogalleryID; ?> a,#huge_it_videogallery_content_<?php echo $videogalleryID; ?> #huge_it_videogallery_container_<?php echo $videogalleryID; ?> .videoelement_<?php echo $videogalleryID; ?> .title-block_<?php echo $videogalleryID; ?> a:link,#huge_it_videogallery_content_<?php echo $videogalleryID; ?> #huge_it_videogallery_container_<?php echo $videogalleryID; ?> .videoelement_<?php echo $videogalleryID; ?> .title-block_<?php echo $videogalleryID; ?> a:visited,
#huge_it_videogallery_content_<?php echo $videogalleryID; ?> #huge_it_videogallery_container_<?php echo $videogalleryID; ?> .videoelement_<?php echo $videogalleryID; ?> .title-block_<?php echo $videogalleryID; ?> a:hover,#huge_it_videogallery_content_<?php echo $videogalleryID; ?> #huge_it_videogallery_container_<?php echo $videogalleryID; ?> .videoelement_<?php echo $videogalleryID; ?> .title-block_<?php echo $videogalleryID; ?> a:focus,#huge_it_videogallery_content_<?php echo $videogalleryID; ?> #huge_it_videogallery_container_<?php echo $videogalleryID; ?> .videoelement_<?php echo $videogalleryID; ?> .title-block_<?php echo $videogalleryID; ?> a:active {
	position:relative;
	display:block;
	vertical-align:middle;
...
<section id="huge_it_videogallery_content_<?php echo $videogalleryID; ?>">
  <div id="huge_it_videogallery_container_<?php echo $videogalleryID; ?>" class="super-list variable-sizes clearfix">
	...
	foreach($page_images as $key=>$row)
	{
		...
		?>
		<div class="videoelement_<?php echo $videogalleryID; ?>" id="huge_it_videogallery_pupup_element_<?php echo $row->id; ?>_child" tabindex="0" data-symbol="<?php echo str_replace('__5_5_5__','%',$row->name); ?>" data-category="alkaline-earth">
 ...
 //}
				...
				<div class="load_more5">
					<div class="load_more_button5"><?php echo $paramssld['video_ht_view1_loadmore_text']; ?></div>
						...
						jQuery(document).ready(function(){
							if(jQuery("#huge_it_videogallery_content_<?php echo $videogalleryID; ?> .load_more_button5").length){
								jQuery("#huge_it_videogallery_content_<?php echo $videogalleryID; ?> .load_more_button5").on("click tap",function(){
									...
									if(jQuery("#huge_it_videogallery_content_<?php echo $videogalleryID; ?> .pagenum:last").val()<jQuery("#huge_it_videogallery_container_<?php echo $videogalleryID; ?> #total").val()) {
										...
										var perpage =<?php echo $count_page; ?>;
										var galleryid="<?php echo $image->videogallery_id; ?>";
										var thumbtext="<?php echo $paramssld["thumb_view_text"]; ?>";
										var linkbutton="<?php echo $paramssld["ht_view2_element_linkbutton_text"]; ?>"
										var showbutton="<?php echo $paramssld["ht_view2_element_show_linkbutton"]?>"
										var width="<?php echo $paramssld['video_ht_view9_video_width']; ?>";
										var height="<?php echo $paramssld['video_ht_view9_video_height']; ?>";
							...
							function getresult(pagenum,perpage,galleryid,thumbtext,linkbutton,showbutton,width,height){
								...
								jQuery.post('<?php echo admin_url("admin-ajax.php"); ?>',data,function(response){
									if(response.success){
										jQuery('#huge_it_videogallery_container_<?php echo $videogalleryID; ?>').append(jQuery(response.success) ).hugeitmicro( 'reloadItems' ).hugeitmicro({ sortBy: 'original-order' }).hugeitmicro( 'reLayout' );
		 ...
		 if(str_replace('__5_5_5__','%',$row->sl_url)==''){
			...
			?>
				...
				<div class="right-block">
					<?php if($paramssld["ht_view2_show_popup_title"]=='on'){?><h3 class="title"><?php echo str_replace('__5_5_5__','%',$row->name); ?></h3><?php } ?>
...
?>
  ...
  <script src="<?php echo plugins_url('../js/jquery.easing.min.js', __FILE__);?>"></script>
  <script src="<?php echo plugins_url('../js/jquery.touchSwipe.min.js', __FILE__);?>"></script>
  <link rel="stylesheet" href="<?php echo plugins_url('../style/animate.min.css', __FILE__);?>">
		...
		<div class="slider-content">
			...
			<div class="slider-content-wrapper">
				<div class="image-block_<?php echo $videogalleryID; ?>">
					...
					?>									
							<?php 	if($row->image_url != ';'){ ?>
							<a class="videogroup<?php echo $videogalleryID; ?>" href="<?php echo $imgurl[0]; ?>" title="<?php echo str_replace('__5_5_5__','%',$row->name); ?>"><img class="main-image" src="<?php echo $imgurl[0]; ?>" alt="<?php echo str_replace('__5_5_5__','%',$row->name); ?>" /></a>
							<?php } else { ?>
							<img class="main-image" src="images/noimage.jpg" alt="<?php echo str_replace('__5_5_5__','%',$row->name); ?>" />
							<?php
							} ?>
				...
				?>
						<?php
							...
							if($videourl[1]=='youtube'){
								...
								?>
								<a class="youtube huge_it_videogallery_item"  href="https://www.youtube.com/embed/<?php echo $videourl[0]; ?>" title="<?php echo str_replace('__5_5_5__','%',$row->name); ?>">
							...
							?>
								<a class="vimeo huge_it_videogallery_item" href="http://player.vimeo.com/video/<?php echo $videourl[0]; ?>" title="<?php echo str_replace('__5_5_5__','%',$row->name); ?>">
...
.videoelement_<?php echo $videogalleryID; ?> .image-block_<?php echo $videogalleryID; ?> {
	position:relative;
	width: 100%;
	max-width:<?php echo $paramssld['ht_view6_width']; ?>px;
}

.videoelement_<?php echo $videogalleryID; ?> .image-block_<?php echo $videogalleryID; ?> a {display:block;}

.videoelement_<?php echo $videogalleryID; ?> .image-block_<?php echo $videogalleryID; ?> img {
...
.videoelement_<?php echo $videogalleryID; ?> .image-block_<?php echo $videogalleryID; ?> img:hover {
	cursor: -webkit-zoom-in; cursor: -moz-zoom-in;
}

.videoelement_<?php echo $videogalleryID; ?> .image-block_<?php echo $videogalleryID; ?> .play-icon {
	position:absolute;
	top:0px;
	left:0px;
	width:100%;
...
.videoelement_<?php echo $videogalleryID; ?> .image-block_<?php echo $videogalleryID; ?>  .play-icon.youtube-icon {background:url(<?php echo plugin_dir_url( __FILE__ ); ?>../images/play.youtube.png) center center no-repeat;}

.videoelement_<?php echo $videogalleryID; ?> .image-block_<?php echo $videogalleryID; ?>  .play-icon.vimeo-icon {background:url(<?php echo plugin_dir_url( __FILE__ ); ?>../images/play.vimeo.png) center center no-repeat;}


.videoelement_<?php echo $videogalleryID; ?> .title-block_<?php echo $videogalleryID; ?> {
	position:absolute;
	text-overflow: ellipsis;
	overflow: hidden; 	
	left:0px;
...
.videoelement_<?php echo $videogalleryID; ?>:hover .title-block_<?php echo $videogalleryID; ?> {bottom:0px;}

.videoelement_<?php echo $videogalleryID; ?> .title-block_<?php echo $videogalleryID; ?> a, .videoelement_<?php echo $videogalleryID; ?> .title-block_<?php echo $videogalleryID; ?> a:link, .videoelement_<?php echo $videogalleryID; ?> .title-block_<?php echo $videogalleryID; ?> a:visited {
	position:relative;
	margin:0px;
	padding:0px 1% 0px 2%;
	width:97%;
...
.videoelement_<?php echo $videogalleryID; ?> .title-block_<?php echo $videogalleryID; ?> a:hover, .videoelement_<?php echo $videogalleryID; ?> .title-block_<?php echo $videogalleryID; ?> a:focus, .videoelement_<?php echo $videogalleryID; ?> .title-block_<?php echo $videogalleryID; ?> a:active {
...
<section id="huge_it_videogallery_content_<?php echo $videogalleryID; ?>">
  <div id="huge_it_videogallery_container_<?php echo $videogalleryID; ?>" class="super-list variable-sizes clearfix">
	...
	foreach($page_images as $key=>$row)
	{
		...
		$result = substr($descnohtml, 0, 50);
		?>
		<div class="videoelement_<?php echo $videogalleryID; ?>" tabindex="0" data-symbol="<?php echo str_replace('__5_5_5__','%',$row->name); ?>" data-category="alkaline-earth">
			<div class="image-block_<?php echo $videogalleryID; ?>">
				<?php 
					$imagerowstype=$row->sl_type;
					if($row->sl_type == ''){$imagerowstype='image';}
				...
				?>
						<?php
							...
							if($videourl[1]=='youtube'){
								...
								?>
								<a class="youtube huge_it_videogallery_item videogroup<?php echo $videogalleryID; ?>"  href="https://www.youtube.com/embed/<?php echo $videourl[0]; ?>" title="<?php echo str_replace('__5_5_5__','%',$row->name); ?>">
									<img src="<?php echo $thumb_pic; ?>" alt="<?php echo str_replace('__5_5_5__','%',$row->name); ?>" />
									<div class="play-icon <?php echo $videourl[1]; ?>-icon"></div>
								</a>								
							<?php
							...
							?>
								<a class="vimeo huge_it_videogallery_item videogroup<?php echo $videogalleryID; ?>" href="http://player.vimeo.com/video/<?php echo $videourl[0]; ?>" title="<?php echo str_replace('__5_5_5__','%',$row->name); ?>">
									<img src="<?php echo $imgsrc; ?>" alt="" />
									<div class="play-icon <?php echo $videourl[1]; ?>-icon"></div>
								</a>
							<?php
		 ...
		 $path_site = plugins_url("/../Front_images", __FILE__); 
			...
			if($a==1){
				...
				<div class="load_more4">
					<div class="load_more_button4"><?php echo $paramssld['video_ht_view4_loadmore_text']; ?></div>
								...
								jQuery.post('<?php echo admin_url("admin-ajax.php"); ?>',data,function(response){
									if(response.success){
										...
										var $objnewitems= jQuery(response.success);										
											jQuery('#huge_it_videogallery_container_<?php echo $videogalleryID; ?>').append( $objnewitems ).hugeitmicro({ sortBy: 'original-order' }) .hugeitmicro( 'reLayout' ).hugeitmicro( 'reloadItems' );
										jQuery('#huge_it_videogallery_container_<?php echo $videogalleryID; ?> img').on('load',function(){
											jQuery('#huge_it_videogallery_container_<?php echo $videogalleryID; ?>').hugeitmicro({ sortBy: 'original-order' }) .hugeitmicro( 'reLayout' ).hugeitmicro( 'reloadItems' );
											//############# Hakob
	...
	if (!function_exists('get_youtube_id_from_url')) {
	  function get_youtube_id_from_url($url){
		if (stristr($url,'youtu.be/'))
			{ preg_match('%(?:youtube(?:-nocookie)?\.com/(?:[^/]+/.+/|(?:v|e(?:mbed)?)/|.*[?&]v=)|youtu\.be/)([^"&?/ ]{11})%i', $url, $final_ID); return $final_ID[4]; }
		else 
			{ preg_match('/(https:|http:|):(\/\/www\.|\/\/|)(.*?)\/(embed\/|watch\?v=|(.*?)&v=|v\/|e\/|.+\/|watch.*v=|)([a-z_A-Z0-9]{11})/i', $url, $IDD); /*var_dump($IDD);*/return $IDD[6]; }
		}                                    
	}
      ...
      <div id="huge_it_slideshow_image_container_videogallery_<?php echo $sliderID; ?>" class="huge_it_slideshow_image_container_videogallery_<?php echo $sliderID; ?>">        
		...
		<script>
							...
							function setResponsiveElements() {
								...
								if(jQuery(window).width() < <?php echo $paramssld['thumb_image_width']; ?>) {
									var currentWidth = jQuery('.huge_it_big_li').width();
									var currentHeight = jQuery('.huge_it_big_li').height();
									var elWidth = <?php echo $paramssld['thumb_image_width']; ?>;
									var elHeight = <?php echo $paramssld['thumb_image_height']; ?>;
								...
								//	jQuery('.image-block_<?php echo $videogalleryID; ?>').height(currentWidth/divWidthHeight);
								//	jQuery('.image-block_<?php echo $videogalleryID; ?> img').height(currentWidth/divWidthHeight);
									//reSortImages(currentWidth,currentWidth/divWidthHeight);
									//alert(divWidthHeight);
								}
								else {
									jQuery('.huge_it_big_li').height(<?php echo $paramssld['thumb_image_height']; ?>);
								}
							}
							/***</add>***/
		</script>
	...
	.clear{
		clear:both;
			...
			<?php if($paramssld["thumb_image_behavior"]=='on'){?>
				height: 100% !important;
				max-height: <?php echo $paramssld["thumb_image_height"]; ?>px !important;
			<?php } ?>
				border: <?php echo $paramssld["thumb_image_border_width"]; ?>px solid #<?php echo $paramssld["thumb_image_border_color"]; ?>;
				border-radius: <?php echo $paramssld["thumb_image_border_radius"]; ?>px;
				margin:0px !important;
		...
		<section id="thumbwrapper<?php echo $videogalleryID; ?>">
			<input type="hidden" class="pagenum" value="1" />
					...
					?>
							<?php
								...
								if($videourl[1]=='youtube'){
									...
									<a  class="youtube huge_it_videogallery_item videogroup<?php echo $videogalleryID; ?>"  href="https://www.youtube.com/embed/<?php echo $videourl[0]; ?>" title="<?php echo str_replace('__5_5_5__','%',$row->name); ?>"></a>
									<img src="<?php echo $thumb_pic; ?>" alt="<?php echo str_replace('__5_5_5__','%',$row->name); ?>" />				
								<?php
								}else {
								...
								?>
									<a  class="vimeo huge_it_videogallery_item videogroup<?php echo $videogalleryID; ?>" href="http://player.vimeo.com/video/<?php echo $videourl[0]; ?>" title="<?php echo str_replace('__5_5_5__','%',$row->name); ?>"></a>
									<img src="<?php echo $imgsrc; ?>" alt="<?php echo str_replace('__5_5_5__','%',$row->name); ?>" />
								<?php
								}
							?>
		 ...
		 $path_site = plugins_url("/../Front_images", __FILE__); 
			...
			if($a==1){
				...
				<div class="load_more3">
					<div class="load_more_button3"><?php echo $paramssld['video_ht_view7_loadmore_text']; ?></div>
					...
					<script>
						jQuery(document).ready(function(){
							if(jQuery("#thumbwrapper<?php echo $videogalleryID; ?> .load_more_button3").length){
								jQuery("#thumbwrapper<?php echo $videogalleryID; ?> .load_more_button3").on("click tap",function(){

									if(jQuery("#thumbwrapper<?php echo $videogalleryID; ?> .pagenum:last").val()<jQuery("#thumbwrapper<?php echo $videogalleryID; ?> #total").val()) {
										var pagenum = parseInt(jQuery("#thumbwrapper<?php echo $videogalleryID; ?> .pagenum:last").val()) + 1;
										var perpage =<?php echo $count_page; ?>;
										var galleryid="<?php echo $image->videogallery_id; ?>";
										var thumbtext="<?php echo $paramssld["thumb_view_text"]; ?>";
										var width="<?php echo $paramssld['video_ht_view9_video_width']; ?>";
										...
										jQuery('#thumbwrapper<?php echo $videogalleryID; ?> .load_more_button3').hide();
									}
									return false;
								});
							}
							...
							function getresult(pagenum,perpage,galleryid,thumbtext,width,height){
								...
								jQuery('#thumbwrapper<?php echo $videogalleryID; ?> .loading3').show();
								
								jQuery('#thumbwrapper<?php echo $videogalleryID; ?> .load_more_button3').hide();

								jQuery.post('<?php echo admin_url("admin-ajax.php"); ?>',data,function(response){
									if(response.success){
										jQuery("#thumbwrapper<?php echo $videogalleryID; ?> #huge_it_videogallery").append(response.success);
										jQuery('#thumbwrapper<?php echo $videogalleryID; ?> #huge_it_videogallery img').on('load',function(){
											...
											jQuery('.non-retina').colorbox({rel:'group5', transition:'none'})
											jQuery('.retina').colorbox({rel:'group5', transition:'none', retinaImage:true, retinaUrl:true});
											jQuery('#thumbwrapper<?php echo $videogalleryID; ?> .load_more_button3').show();
											jQuery('#thumbwrapper<?php echo $videogalleryID; ?> .loading3').hide();
...
<input type="hidden" id="total" value="<?php echo $total; ?>" />
                    ...
                    ?>
                                <?php 	if($row->image_url != ';'){ ?>
                                <a class="videogroup<?php echo $videogalleryID; ?>" href="<?php echo $imgurl[0]; ?>" title="<?php echo str_replace('__5_5_5__','%',$row->name); ?>">
		 ...
		 $path_site = plugins_url("/../Front_images", __FILE__); 
			...
			if($a==1){
				...
				<div class="load_more2">
					<div class="load_more_button2 load_more_button_<?php echo $videogalleryID; ?>"><?php echo $paramssld['video_ht_view8_loadmore_text']; ?></div>
					<div class="loading2 loading_<?php echo $videogalleryID; ?>"><img src="<?php if($paramssld['video_ht_view8_loading_type'] == '1') {echo $path_site.'/arrows/loading1.gif';} 
...
<div class="video_view9_cont_wrapper" id="video_view9_cont_wrapper_video<?php echo $videogalleryID; ?>">
	<div id="video_view9_cont_list_video<?php echo $videogalleryID; ?>">
		<?php
		...
		<?php 
		 $path_site = plugins_url("/../Front_images", __FILE__); 
			...
			if($a==1){
				...
				?>
				<div class="load_more">
					<div class="load_more_button"><?php echo $paramssld['video_ht_view9_loadmore_text']; ?></div>
					...
					<script>
						jQuery(document).ready(function(){
							if(jQuery("#video_view9_cont_wrapper_video<?php echo $videogalleryID; ?> .load_more_button").length){
								jQuery("#video_view9_cont_wrapper_video<?php echo $videogalleryID; ?> .load_more_button").on("click tap",function(){
									if(jQuery("#video_view9_cont_wrapper_video<?php echo $videogalleryID; ?> .pagenum:last").val()<jQuery("#video_view9_cont_wrapper_video<?php echo $videogalleryID; ?> #total").val()) {
										var pagenum = parseInt(jQuery("#video_view9_cont_wrapper_video<?php echo $videogalleryID; ?> .pagenum:last").val()) + 1;
										var perpage =<?php echo $count_page; ?>;
										var galleryid="<?php echo $image->videogallery_id; ?>";
										var width="<?php echo $paramssld['video_ht_view9_video_width']; ?>";
										var height="<?php echo $paramssld['video_ht_view9_video_height']; ?>";
										var position="<?php echo $paramssld['video_view9_image_position']; ?>";
										getresult(pagenum,perpage,galleryid,width,height,position);
									}else{
										jQuery('#video_view9_cont_wrapper_video<?php echo $videogalleryID; ?> .load_more_button').hide();
									}
									return false;
								});
							}
if(jQuery("#video_view9_cont_wrapper_video<?php echo $videogalleryID; ?> .pagenum:last").val()==jQuery("#video_view9_cont_wrapper_video<?php echo $videogalleryID; ?> #total").val()) {
							...
							function getresult(pagenum,perpage,galleryid,width,height,position){
								...
								jQuery('#video_view9_cont_wrapper_video<?php echo $videogalleryID; ?> .loading').show();
								jQuery('#video_view9_cont_wrapper_video<?php echo $videogalleryID; ?> .load_more_button').hide();
								jQuery.post('<?php echo admin_url("admin-ajax.php"); ?>',data,function(response){
									if(response.success){
										setTimeout(function(){
											jQuery("#video_view9_cont_list_video<?php echo $videogalleryID; ?>").append(response.success);
											jQuery('#video_view9_cont_wrapper_video<?php echo $videogalleryID; ?> .load_more_button').show();
											jQuery('#video_view9_cont_wrapper_video<?php echo $videogalleryID; ?> .loading').hide();
